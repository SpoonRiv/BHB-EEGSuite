    ...
    return {
        ...
        "ui": {
            "waveform": {
                ...
                "ppg_y_axis_fixed_max_default": float(getattr(state.config.ui.waveform, "ppg_y_axis_fixed_max_default", 20000.0)),
                "ppg_y_axis_fixed_max_min": float(getattr(state.config.ui.waveform, "ppg_y_axis_fixed_max_min", 1000.0)),
                "ppg_y_axis_fixed_max_max": float(getattr(state.config.ui.waveform, "ppg_y_axis_fixed_max_max", 200000.0)),
                "ppg_y_axis_fixed_max_step": float(getattr(state.config.ui.waveform, "ppg_y_axis_fixed_max_step", 1000.0)),
            }
        },
